	...
	<div class="center">
		<div class="navlinks">
			<div class="linklist">
				...
				<a href="https://github.com/streetcomplete/streetcomplete"><img style="float: left; margin-right: 4px;" width="20" height="20" src="res/logo_github.png" alt="GitHub"><?php echo $strings["about_title_repository"]; ?> (GitHub)</a>
			...
			<div class="linklist">
				...
				<div>
					...
					<a href="https://github.com/sponsors/westnordost"><img width="64" height="64" src="res/logo_github.png" alt="GitHub Sponsors"></a>
					<a href="https://patreon.com/westnordost"><img width="64" height="64" src="res/logo_patreon.png" alt="Patreon"></a>
				</div>
			</div>
			<div class="linklist">
